...
const savedScroll = sessionStorage.getItem("TG_SCROLL");

if (savedFilter) {
  filterType = savedFilter;

  if (filterType === "ACTIVE") setActiveButton("btnActive");
  else if (filterType === "REMOVED") setActiveButton("btnRemoved");
...
function openPaymentPage(guestMobile) {
  ...
  sessionStorage.setItem("TG_SCROLL", document.querySelector(".table-body-scroll").scrollTop);
  sessionStorage.setItem("TG_FILTER", filterType);
  sessionStorage.setItem("TG_CYCLE_FILTER", cycleFilter);
